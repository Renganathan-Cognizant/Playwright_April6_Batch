...
for(const dt of data1){
    test(`json test No: ${dt.ID}`, async ({page})=>{
        await page.goto("https://opensource-demo.orangehrmlive.com/")
...
4. const data1 = JSON.parse(fs.readFileSync(path.join(__dirname,"../../TestData/recruitmentdata.json"),'utf-8')) 
-> stores the data in variable data1
*/