...
test('frames approach1', async ({page})=>{
    ...
    //?. optional chaining - if myFrame is null or undefined, 
    // it will not throw an error and will return undefined instead. 
    // This prevents potential runtime errors when trying 
    // to access properties or methods on a null or undefined object.
